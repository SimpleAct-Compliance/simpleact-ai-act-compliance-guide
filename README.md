...
1. obligations are discussed before systems are inventoried
2. classification happens without structured inputs
3. documentation starts too late
...
Within that model, the operating order is stable:
...
- SaaS companies with customer-facing AI functionality
